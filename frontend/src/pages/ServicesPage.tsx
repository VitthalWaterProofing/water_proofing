...
export default function ServicesPage() {
  ...
  function ServiceDetail({ service, index, openInspection }: { service: ServiceType, index: number, openInspection: () => void }) {
            ...
            <div className="md:w-1/2 w-full">
              ...
              <div className="flex flex-col items-start gap-5">
                ...
                <button
                  ...
                  className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-full text-sm font-medium transition cursor-pointer">
                  Book Inspection
                </button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
              {[
                ...
                <div key={index} className="flex flex-col items-center">
                  <div className="aspect-square w-16 rounded-full flex items-center justify-center mb-6 *:bg-blue-600/20 border border-blue-400/40 shadow-[0_0_25px_rgba(59,130,246,0.35)]">
